  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="infrastructure" className="mt-10">
        ...
        <section id="platform" className="py-0 bg-background">
          <div className="aspect-[2/3] overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5 mx-auto max-w-7xl px-6 lg:px-12">
            <div className="h-full p-8 lg:p-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-4xl font-mono font-bold text-primary mb-4">500+</div>
                  <div className="font-semibold mb-2">Integrated Tools</div>
                  <div className="text-sm text-muted-foreground">API-first architecture connects everything</div>
                </div>
                <div className="text-center p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-4xl font-mono font-bold text-primary mb-4">400%</div>
                  <div className="font-semibold mb-2">Developer Growth</div>
                  <div className="text-sm text-muted-foreground">Ecosystem expanding exponentially</div>
                </div>
                <div className="text-center p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-4xl font-mono font-bold text-primary mb-4">∞</div>
                  <div className="font-semibold mb-2">Scale Potential</div>
                  <div className="text-sm text-muted-foreground">Infrastructure built for infinite growth</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="aspect-[2/3] overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5 mx-auto max-w-7xl px-6 lg:px-12">
            <div className="h-full p-8 lg:p-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-lg font-semibold text-foreground mb-3">
                    "Every knowledge worker's day begins with AI-generated priorities"
                  </div>
                  <div className="text-muted-foreground">Intelligent task orchestration eliminates decision fatigue</div>
                </div>
                <div className="p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-lg font-semibold text-foreground mb-3">
                    "Every team decision is informed by collective intelligence"
                  </div>
                  <div className="text-muted-foreground">Network effects multiply organizational wisdom</div>
                </div>
                <div className="p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-lg font-semibold text-foreground mb-3">
                    "Every company scales through intelligent automation"
                  </div>
                  <div className="text-muted-foreground">Infrastructure handles complexity as teams grow</div>
                </div>
                <div className="p-8 bg-background rounded-3xl border border-border hover:border-primary hover:shadow-lg transition-all duration-300">
                  <div className="text-lg font-semibold text-foreground mb-3">
                    "Every breakthrough happens 40% faster"
                  </div>
                  <div className="text-muted-foreground">AI acceleration compounds across all activities</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <footer className="py-20 bg-background">
          <div className="aspect-[2/3] overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5 mx-auto max-w-7xl px-6 lg:px-12">
            <div className="bg-muted/30 h-full p-8 lg:p-16">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="col-span-2 md:col-span-1">
                  {/* <ChatPMLogo className="mb-4" /> */}
                  <p className="text-sm text-muted-foreground mb-4">
                    AI infrastructure for the future of work. Building the platform that will power how humanity collaborates.
                  </p>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li><a href="#" className="hover:text-foreground">Infrastructure</a></li>
                    <li><a href="#" className="hover:text-foreground">API Documentation</a></li>
                    <li><a href="#" className="hover:text-foreground">Integrations</a></li>
                    <li><a href="#" className="hover:text-foreground">Developer Tools</a></li>
                  </ul>
                </div>
              ...
              <div className="border-t border-border mt-12 pt-8 text-center text-sm text-muted-foreground">
                <p>&copy; 2024 ChatPM. All rights reserved. Building the future of work.</p>
              </div>
            </div>
          </div>
        </footer>
